...
<head>
    ...
    <title>Food Inventory</title> <!-- Title of the webpage -->
...
<body>
  ...
  <input type="text" id="myInput" onkeyup="searchByNameFunc()" placeholder="Search for names.." title="Type in a name">
    ...
    <div class="dropdown-menu" id="dropdown-menu" role="menu">
      <div class="dropdown-content">
        <div class='dropdown-item'>
          <label id="ascend-alpha" class="checkbox">
            A-Z
            <input type="checkbox" onclick="sortTable('asc')"/>
          </label>        
        </div>
        <div class="dropdown-item">
          <label id="descend-alpha" class="checkbox">
            Z-A
